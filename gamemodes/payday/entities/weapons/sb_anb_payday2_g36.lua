...
SWEP.PrintName = "JP36 (G36) for SB ANB PAYDAY 2"
SWEP.WorldModel = "models/sb_anb_payday2/weapon_g36.mdl"
SWEP.HoldType = "ar2"
SWEP.Weight = 4
...
SWEP.ShotSound = Sound("sb_anb_payday2/weapons/shot_g36.mp3")
