...
SWEP.PrintName = "Compact-5 (MP5) for SB ANB PAYDAY 2"
SWEP.WorldModel = "models/sb_anb_payday2/weapon_mp5.mdl"
SWEP.HoldType = "smg"
SWEP.Weight = 3
...
SWEP.ShotSound = Sound("sb_anb_payday2/weapons/shot_mp5.mp3")
