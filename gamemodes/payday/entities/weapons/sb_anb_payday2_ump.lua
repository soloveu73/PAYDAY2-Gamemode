...
SWEP.PrintName = "Jackal (UMP) for SB ANB PAYDAY 2"
SWEP.WorldModel = "models/sb_anb_payday2/weapon_ump.mdl"
SWEP.HoldType = "smg"
SWEP.Weight = 3
...
SWEP.ShotSound = Sound("sb_anb_payday2/weapons/shot_ump.mp3")
