...
SWEP.PrintName = "Compact-5 (Tactical MP5) for SB ANB PAYDAY 2"
SWEP.WorldModel = "models/sb_anb_payday2/weapon_mp5_tactical.mdl"
SWEP.HoldType = "smg"
SWEP.Weight = 3
...
SWEP.FullShootDamage = 5

SWEP.InternalSpreadDegrees = 0
SWEP.MuzzleEffect = false

SWEP.ShotSound = Sound("sb_anb_payday2/weapons/shot_mp5_tactical.mp3")
